...
class Newsvg{
    render(){
return (<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1000 500">
            <g id="homeLogo" transform="translate(125 500) scale(0.5)">
                <path className="logo_handle" fill="none" stroke="brown" stroke-width="10" d="M 250.00,195.00
                ...
                <path className="logo_J" fill="none" stroke="Black" stroke-width="15" d="M 250.00,311.00
                ...
                <text x="260" y="485" textLength="740">osh Miccolo</text> 
        </svg >)
}
}
